...
科研效率资料库：文献综述 prompt、医学论文翻译术语表、Zotero 阅读工作流、科研选题表。

这些模板面向临床医生、医学生、研究生、科研人员和需要长期阅读英文论文的人。你可以直接复制 Markdown 模板，也可以下载 CSV/ZIP 文件后改成自己的 Notion、飞书、Excel 或 Zotero 工作流。
